...
import com.example.tictactoegame.databinding.FragmentFxfBinding
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase
import java.text.DateFormat
import java.util.Calendar

class fxfFragment : Fragment() {
...
//    Store Replay to Firebase
    ...
    override fun onCreateView(
        ...
        binding = FragmentFxfBinding.inflate(inflater, container, false)
        initBoard()
    ...
    private fun checkForVictory(s: String): Boolean {
        ...
        if (match(binding.d1, s) && match(binding.d2, s) && match(binding.d3, s)) {
            return true
        }

        // 4x4
        if (match(binding.a2, s) && match(binding.a3, s) && match(binding.a4, s)) {
            return true
        }
        if (match(binding.b2, s) && match(binding.b3, s) && match(binding.b4, s)) {
            return true
        }
        if (match(binding.c2, s) && match(binding.c3, s) && match(binding.c4, s)) {
            return true
        }
        if (match(binding.d2, s) && match(binding.d3, s) && match(binding.d4, s)) {
            return true
        }
        ...
        if (match(binding.a4, s) && match(binding.b4, s) && match(binding.c4, s)) {
            return true
        }

        // 3x4 and 4x4
        if (match(binding.b1, s) && match(binding.c1, s) && match(binding.d1, s)) {
            return true
        }
        if (match(binding.b2, s) && match(binding.c2, s) && match(binding.d2, s)) {
            return true
        }
        if (match(binding.b3, s) && match(binding.c3, s) && match(binding.d3, s)) {
            return true
        }
        if (match(binding.b4, s) && match(binding.c4, s) && match(binding.d4, s)) {
            return true
        }
        ...
        // 3x4
        if (match(binding.b1, s) && match(binding.c2, s) && match(binding.d3, s)) {
            return true
        }
        if (match(binding.b3, s) && match(binding.c2, s) && match(binding.d1, s)) {
            return true
        }

        // 4x4
        if (match(binding.a2, s) && match(binding.b3, s) && match(binding.c4, s)) {
            return true
        }
        if (match(binding.a4, s) && match(binding.b3, s) && match(binding.c2, s)) {
            return true
        }

        if (match(binding.b2, s) && match(binding.c3, s) && match(binding.d4, s)) {
            return true
        }
        if (match(binding.b4, s) && match(binding.c3, s) && match(binding.d2, s)) {
            return true
        }
